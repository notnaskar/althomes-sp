...
test.describe('Contact page (/contact)', () => {
  ...
  test('renders social links (Facebook and Instagram) from site settings', async ({ page }) => {
  ...
  test('submitting valid form shows success state', async ({ page }) => {
    ...
    await page.fill('#cf-message', 'Hello, I have a question about your properties.')
