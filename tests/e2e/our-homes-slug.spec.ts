...
test.describe('Property detail page (/our-homes/[slug])', () => {
  test.todo('renders hero image')
  test.todo('renders property title')
  test.todo('renders gallery section')
  ...
  test.todo('renders bottom CTA with FIND AVAILABILITY button')
})
