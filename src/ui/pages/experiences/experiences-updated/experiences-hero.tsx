		...
		<section className="bg-background relative w-full overflow-hidden px-[90px] pt-[140px] pb-[80px] max-[820px]:px-[18px] max-[820px]:pt-[100px] max-[820px]:pb-[56px]">
			...
			<div className="relative grid grid-cols-2 gap-x-[80px] max-[820px]:grid-cols-1 max-[820px]:text-center">
				...
				<div className="flex flex-col justify-between gap-[80px] max-[820px]:gap-[24px]">
					<h1 className="text-foreground font-['Playfair_Display'] text-[72px] leading-[70px] font-normal tracking-[0.1em] italic max-[820px]:text-[60px] max-[820px]:leading-[52px] max-[820px]:tracking-[0.09em]">
					...
					<p className="text-foreground max-w-[432px] font-['Playfair_Display'] text-[30px] leading-[40px] tracking-[0.1em] italic max-[820px]:max-w-none max-[820px]:text-[19px] max-[820px]:leading-[29px]">
						{supportingTagline}
					</p>
				</div>
				...
				<div className="relative flex flex-col justify-start pt-[8px] max-[820px]:mt-[28px] max-[820px]:pt-0">
					<p className="text-foreground font-['Playfair_Display'] text-[30px] leading-[40px] tracking-[0.1em] italic max-[820px]:text-[19px] max-[820px]:leading-[29px]">
