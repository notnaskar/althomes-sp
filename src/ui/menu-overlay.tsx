...
export default function MenuOverlay({ isOpen, onCloseAction, site }: Props) {
	...
	return (
		<div
			className="fixed inset-0 z-50 grid md:grid-cols-[1fr_415px] animate-in fade-in duration-200"
		...
		>
			...
			<aside
				...
				style={{ background: '#2F5D50', color: '#FCF6EA', padding: '48px 40px 40px' }}
			>
				<div className="flex justify-between items-center md:justify-end gap-6 mb-10">
					{site?.navCtaLink && (
						<NavCta
					...
					>
						<svg viewBox="0 0 25 25" width="25" height="25" fill="none">
							<line x1="3" y1="3" x2="22" y2="22" stroke="#FCF6EA" strokeWidth="2" strokeLinecap="round" />
							<line x1="22" y1="3" x2="3" y2="22" stroke="#FCF6EA" strokeWidth="2" strokeLinecap="round" />
						</svg>
					</button>
				</div>
